...
// Pagina /varejo: LP "Smart Locker para varejo", spin-off de
// app/condominio/CondominioClient.tsx com a mesma arquitetura.
//
// Este arquivo e so a montagem. Cada capitulo vive em components/varejo/* e
// cuida da propria copy, do proprio layout e do proprio evento de analytics.
...
import Faq from '@/components/varejo/Faq'
import Fechamento from '@/components/varejo/Fechamento'
import StickyCta from '@/components/varejo/StickyCta'
import LeadModal from '@/components/varejo/LeadModal'
...
export default function VarejoClient() {
  ...
  useEffect(() => {
    document.body.classList.add('lp-varejo')
    return () => document.body.classList.remove('lp-varejo')
  }, [])
